...
const Table = () => {
  ...
  return data && !loading ? (
    <div>
      <table className="border-collapse bg-white rounded-lg h-[30vh] w-[60vw] shadow-md ml-[30px]">
        <thead>
    ...
    <div className="flex items-center justify-center h-[30vh] w-[60vw] bg-gray-500 ml-[30px]">
      <div role="status">
        <svg
          aria-hidden="true"
